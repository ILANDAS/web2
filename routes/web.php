...
//use App\Http\Controllers\MesaPartes;
...
Route::get('/', App\Http\Controllers\PagesController::class)->name('basepath');

route::get('/menus',[ProductoController::class,'index'])->name('menus');
